                ...
                <div className="max-h-56 overflow-y-auto rounded-xl border border-google-border dark:border-slate-800 divide-y divide-google-border dark:divide-slate-800">
                  {analytics.analyticsData.map((visit, index) => (
                    <div
                      ...
                      className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-4 py-3 bg-white dark:bg-slate-900 text-sm animate-fade-in"
                    >
                      ...
                      {visit.country && (
                        <span className="text-xs px-2 py-0.5 rounded bg-slate-50 dark:bg-slate-855 border border-google-border dark:border-slate-800 text-google-gray dark:text-slate-400 font-semibold self-start sm:self-auto flex items-center gap-1 shadow-sm">
