  ...
  return (
    <div className="w-full max-w-3xl mx-auto bg-white border border-google-border rounded-2xl shadow-card p-8 sm:p-10 animate-fade-in space-y-8">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed text-sm sm:text-base">
        ...
        <h3 className="text-lg font-bold text-gray-900">2. Acceptable Use</h3>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-1 text-google-gray">
        ...
        <h3 className="text-lg font-bold text-gray-900">3. Service Limitations & Availability</h3>
        <p>
        ...
        <h3 className="text-lg font-bold text-gray-900">4. Changes to Terms</h3>
        <p>
